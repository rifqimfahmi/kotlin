...
class AtomicfuIrBuilder internal constructor(
    ...
    fun atomicGetValue(valueType: IrType, receiver: IrExpression, obj: IrExpression) =
        irCall(atomicSymbols.getAtomicHandlerFunctionSymbol(atomicSymbols.getFieldUpdaterClass(valueType), "get")).apply {
    ...
    fun callFieldUpdater(
        ...
        return if (isBooleanReceiver && irCall.type.isInt()) irCall.toBoolean() else irCall // todo also move this to apply block
    }
            ...
            +irWhile().apply {
                ...
                body = irBlock {
                    ...
                    +irIfThen(
                        ...
                        condition = irCall(atomicSymbols.getAtomicHandlerFunctionSymbol(atomicSymbols.getFieldUpdaterClass(valueType), "compareAndSet")).apply {
